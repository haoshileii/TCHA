...
import numpy as np
from .dilated_conv import DilatedConvEncoder, projectionencoder
...
class TSEncoder(nn.Module):
    def __init__(self, input_dims, output_dims, hidden_dims=64, depth=10, mask_mode='binomial'):
        ...
        self.gru = nn.GRU(64, 256, 3)
        self.input_fc2 = nn.Linear(input_dims, 512)  #
        self.feature_extractor = DilatedConvEncoder(
            hidden_dims,
            [hidden_dims] * depth + [output_dims],
            kernel_size = 3
        )
        decoder_layer = TransformerEncoderLayer(d_model=384, nhead=8, dropout=0.1)
